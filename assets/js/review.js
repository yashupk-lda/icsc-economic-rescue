...
(function(){
 ...
 const challenges=d.challenges.map((x,i)=>`<article class="challengeCard"><div class="difficulty">Challenge ${i+1} • application</div><h3>${x[0]}</h3><details><summary>Show answer logic</summary><p>${x[1]}</p></details></article>`).join('');
