...
if(t==='intro')m.innerHTML=`<div class="eyebrow">Mission 2 • Market Builder</div><h1>Individual and Market Demand</h1><p class="big">You’ll classify, match, add buyers, plot curves, predict changes and repair bad economics.</p><div class="scene"><div class="bigIcon">👤 ➕ 👤 ➕ 👤 = 📈</div><p>By the end, you should be able to build a market demand curve yourself.</p></div>`;
...
else m.innerHTML=`<div class="eyebrow">Mission complete</div><h1>Market Demand Review</h1><p class="big">You defined demand, built individual and market demand, plotted curves, classified types and fixed bad reasoning.</p><div class="feedback show good">Next: why does the demand curve slope downward?</div>`;save()}
