...
function header(){syncMissionNavigation();
  ...
  el("progress").style.width=((state.i+1)/screens.length*100)+"%";
...
el("hint").addEventListener("click",()=>{
  const d=document.createElement("div");d.className="feedback show hint";d.innerHTML="<b>Ask one question first:</b> what changed? If it was the product's <b>own price</b>, think movement. If something else changed, think shift.";
  el("main").appendChild(d);tone("click");
});
